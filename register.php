...
<body>
    ...
    <div class="top-content">
        <h1 style="font-size:35px;">Welcome to Radiance</h1>
        <h2>Where every story sparkles🎇<h2>
        <p>Share your journey, connect with loved ones, and treasure the glow of unforgettable moments.
        </p>
    ...
    <footer>			
    	<div class="footer"> 
    		...
    		<p> ©2024 All Rights Reserved <BR> Website designed and developed by <strong><U>Abiah</u></strong></p>
    	</div>
    </footer>
